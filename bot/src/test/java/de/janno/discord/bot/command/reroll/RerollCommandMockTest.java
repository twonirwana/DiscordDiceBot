...
public class RerollCommandMockTest {
    ...
    void customDice_reroll() {
        ...
        CustomDiceConfig config = new CustomDiceConfig(null, ImmutableList.of(new ButtonIdLabelAndDiceExpression("1_button", "Dmg", "3d6+5d!4+3d[a/b/c/d]", false, false)), AnswerFormatType.full, AnswerInteractionType.reroll, null, new DiceStyleAndColor(DiceImageStyle.none, "none"), Locale.ENGLISH);
