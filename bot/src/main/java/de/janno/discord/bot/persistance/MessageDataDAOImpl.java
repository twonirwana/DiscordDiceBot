...
public class MessageDataDAOImpl implements MessageDataDAO {
    ...
    public MessageDataDAOImpl(@NonNull String url, @Nullable String user, @Nullable String password) {
        ...
        queryGauge("db.guild-30d.active", "select count (distinct GUILD_ID) from MESSAGE_DATA where (CURRENT_DATE - CREATION_DATE) <= interval '30' DAY;", connectionPool, Set.of());
