...
public class ChannelConfigCommand implements SlashCommand {
    ...
    private static final CommandDefinitionOption SAVE_ALIAS_OPTION = CommandDefinitionOption.builder()
            ...
            .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.save.name"))
            .description(I18n.getMessage("channel_config.option.save.description", Locale.ENGLISH))
            .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.save.description"))
            .option(CommandDefinitionOption.builder()
                    .type(CommandDefinitionOption.Type.STRING)
                    .name(ALIAS_NAME_OPTION_NAME)
                    .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.aliasName.name"))
                    .description(I18n.getMessage("channel_config.option.aliasName.description", Locale.ENGLISH))
                    .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.aliasName.description"))
                    .required(true)
                    .build())
            .option(CommandDefinitionOption.builder()
                    .type(CommandDefinitionOption.Type.STRING)
                    .name(ALIAS_VALUE_OPTION_NAME)
                    .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.value.name"))
                    .description(I18n.getMessage("channel_config.option.value.description", Locale.ENGLISH))
                    .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.value.description"))
                    .required(true)
                    .build())
            .build();
    private static final CommandDefinitionOption MULTI_SAVE_ALIAS_OPTION = CommandDefinitionOption.builder()
            ...
            .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.multiSave.name"))
            .description(I18n.getMessage("channel_config.option.multiSave.description", Locale.ENGLISH))
            .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.multiSave.description"))
            .option(CommandDefinitionOption.builder()
                    .type(CommandDefinitionOption.Type.STRING)
                    .name(ALIASES_OPTION_NAME)
                    .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.aliases.name"))
                    .description(I18n.getMessage("channel_config.option.aliases.description", Locale.ENGLISH))
                    .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.aliases.description"))
                    .required(true)
                    .build())
            .build();
    private static final CommandDefinitionOption DELETE_ALIAS_OPTION = CommandDefinitionOption.builder()
            ...
            .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.delete.name"))
            .description(I18n.getMessage("channel_config.option.delete.description", Locale.ENGLISH))
            .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.delete.description"))
            .option(CommandDefinitionOption.builder()
                    .type(CommandDefinitionOption.Type.STRING)
                    .name(ALIAS_NAME_OPTION_NAME)
                    .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.aliasName.name"))
                    .description(I18n.getMessage("channel_config.option.delete.aliasName.description", Locale.ENGLISH))
                    .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.delete.aliasName.description"))
                    .required(true)
                    .build())
            .build();
    private static final CommandDefinitionOption LIST_ALIAS_OPTION = CommandDefinitionOption.builder()
            ...
            .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.list.name"))
            .description(I18n.getMessage("channel_config.option.list.description", Locale.ENGLISH))
            .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.list.description"))
            .build();
    ...
    public @NonNull CommandDefinition getCommandDefinition() {
        return CommandDefinition.builder()
                .name(getCommandId())
                .nameLocales(I18n.allNoneEnglishMessages("channel_config.name"))
                .description(I18n.getMessage("channel_config.description", Locale.ENGLISH))
                .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.description"))
                .option(CommandDefinitionOption.builder()
                        .name(SAVE_DIRECT_ROLL_CONFIG_OPTION_NAME)
                        .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.save_direct_roll_config.name"))
                        .description(I18n.getMessage("channel_config.option.save_direct_roll_config.description", Locale.ENGLISH))
                        .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.save_direct_roll_config.description"))
                        .type(CommandDefinitionOption.Type.SUB_COMMAND)
                        ...
                        .option(CommandDefinitionOption.builder()
                                ...
                                .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.always_sum_result.name"))
                                .description(I18n.getMessage("channel_config.option.always_sum_result.description", Locale.ENGLISH))
                                .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.always_sum_result.description"))
                ...
                .option(CommandDefinitionOption.builder()
                        ...
                        .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.delete_direct_roll_config.name"))
                        .description(I18n.getMessage("channel_config.option.delete_direct_roll_config.description", Locale.ENGLISH))
                        .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.delete_direct_roll_config.description"))
                        .type(CommandDefinitionOption.Type.SUB_COMMAND_GROUP)
                        .build())
                .option(CommandDefinitionOption.builder()
                        .name(CHANNEL_ALIAS_OPTION_NAME)
                        .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.channel_alias.name"))
                        .description(I18n.getMessage("channel_config.option.channel_alias.description", Locale.ENGLISH))
                        .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.channel_alias.description"))
                        .type(CommandDefinitionOption.Type.SUB_COMMAND_GROUP)
                ...
                .option(CommandDefinitionOption.builder()
                        ...
                        .nameLocales(I18n.allNoneEnglishMessages("channel_config.option.user_channel_alias.name"))
                        .description(I18n.getMessage("channel_config.option.user_channel_alias.description", Locale.ENGLISH))
                        .descriptionLocales(I18n.allNoneEnglishMessages("channel_config.option.user_channel_alias.description"))
                        .type(CommandDefinitionOption.Type.SUB_COMMAND_GROUP)
                        .option(SAVE_ALIAS_OPTION)
                        .option(DELETE_ALIAS_OPTION)
                        .option(LIST_ALIAS_OPTION)
