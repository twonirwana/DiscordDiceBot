...
public class RpgSystemCommandPreset {
    ...
    public static Config createConfig(PresetId presetId, Locale userLocale) {
        return switch (presetId) {
            ...
            case FATE ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.FATE.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.FATE.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.none, DiceImageStyle.none.getDefaultColor()));
            //4d[-1,0,1]+{Modifier:-4<=>10}=
            case FATE_IMAGE ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.FATE_IMAGE.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.FATE_IMAGE.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.fate, DiceImageStyle.fate.getDefaultColor()));
            ...
            case DND5 -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.DND5.expression", userLocale)),
                    AnswerFormatType.full,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.DND5.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.none, DiceImageStyle.none.getDefaultColor())
            );
            case DND5_IMAGE -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.DND5_IMAGE.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.DND5_IMAGE.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_RdD, DiceImageStyle.polyhedral_RdD.getDefaultColor())
            );
            //custom_parameter start expression: {Number of Dice}d!10>=8c
            case NWOD ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.NWOD.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.NWOD.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_knots, DiceImageStyle.polyhedral_knots.getDefaultColor()));
            ...
            case OWOD ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.OWOD.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.OWOD.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            ...
            case SHADOWRUN_IMAGE ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.SHADOWRUN_IMAGE.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.SHADOWRUN_IMAGE.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.d6_dots, D6Dotted.BLACK_AND_GOLD));
            case COIN -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.COIN.expression", userLocale)),
                    AnswerFormatType.only_result,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.COIN.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.none, DiceImageStyle.none.getDefaultColor())
            );
            //sum_custom_set start buttons: 7;8;9;+;-;4;5;6;d;k;1;2;3;0;l always_sum_result: true
            case DICE_CALCULATOR ->
                    new SumCustomSetConfig(null, ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.DICE_CALCULATOR.expression", userLocale)), true, false, false, null, null, AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.DICE_CALCULATOR.name", userLocale), new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            ...
            case OSR -> new CustomDiceConfig(null,
                    ...
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.OSR.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor())
            );
            //sum_custom_set start buttons:+2d6;+(3d6k2)@Boon;+(3d6l2)@Bane;+1d6;+1;+2;+3;+4;-1;-2;-3;-4
            case TRAVELLER ->
                    new SumCustomSetConfig(null, ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.TRAVELLER.expression", userLocale)), true, true, false, null, null, AnswerFormatType.full, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.TRAVELLER.name", userLocale), new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            //custom_parameter start expression: (d!!{Dice:4@D4/6@D6/8@D8/12@D12/20@D20} + {Type: 0@Regular/1d!!6@Wildcard})k1
            case SAVAGE_WORLDS ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.SAVAGE_WORLDS.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.SAVAGE_WORLDS.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            ...
            case BLADES_IN_THE_DARK ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.BLADES_IN_THE_DARK.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.BLADES_IN_THE_DARK.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.none, DiceImageStyle.none.getDefaultColor()));
            case BLADES_IN_THE_DARK_IMAGE ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.BLADES_IN_THE_DARK.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.BLADES_IN_THE_DARK_IMAGE.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_RdD, DiceImageStyle.polyhedral_RdD.getDefaultColor()));
            case BLADES_IN_THE_DARK_DETAIL ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.BLADES_IN_THE_DARK_DETAIL.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.BLADES_IN_THE_DARK_DETAIL.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_RdD, DiceImageStyle.polyhedral_RdD.getDefaultColor()));
            ...
            case CALL_OF_CTHULHU_7ED -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.CALL_OF_CTHULHU_7ED.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.CALL_OF_CTHULHU_7ED.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor())
            );
            ...
            case EXALTED_3ED ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.EXALTED_3ED.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.EXALTED_3ED.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            ...
            case VAMPIRE_5ED ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.VAMPIRE_5ED.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.reroll, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.VAMPIRE_5ED.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_knots, DiceImageStyle.polyhedral_knots.getDefaultColor()));
            ...
            case HUNTER_5ED ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.HUNTER_5ED.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.reroll, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.HUNTER_5ED.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_knots, DiceImageStyle.polyhedral_knots.getDefaultColor()));
            ...
            case ONE_ROLL_ENGINE ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.ONE_ROLL_ENGINE.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.ONE_ROLL_ENGINE.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            ...
            case DUNGEON_CRAWL_CLASSICS ->
                    new SumCustomSetConfig(null, ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.DUNGEON_CRAWL_CLASSICS.expression", userLocale)), true, true, false, null, null, AnswerFormatType.full, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.DUNGEON_CRAWL_CLASSICS.name", userLocale), new DiceStyleAndColor(DiceImageStyle.none, DiceImageStyle.none.getDefaultColor()));
            ...
            case TINY_D6 -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.TINY_D6.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.TINY_D6.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor())
            );
            //Cyberpunk Red val('$roll', 1d10), if('$roll' =? 1, '$roll'-1d10, '$roll' =?10, '$roll'+1d10, '$roll')+{ability:0<=>9}+{skill:0<=>9}=
            case CYBERPUNK_RED ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.CYBERPUNK_RED.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.CYBERPUNK_RED.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            ...
            case CITY_OF_MIST ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.CITY_OF_MIST.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.CITY_OF_MIST.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            ...
            case RISUS ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.RISUS.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.RISUS.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            ...
            case KIDS_ON_BROOMS ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.KIDS_ON_BROOMS.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.KIDS_ON_BROOMS.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            ...
            case DND5_CALC ->
                    new SumCustomSetConfig(null, ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.DND5_CALC.expression", userLocale)), true, false, false, null, null, AnswerFormatType.full, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.DND5_CALC.name", userLocale), new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            ...
            case REVE_DE_DRAGON -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.REVE_DE_DRAGON.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.REVE_DE_DRAGON.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_RdD, DiceImageStyle.polyhedral_RdD.getDefaultColor())
            );
            ...
            case PUBLIC_ACCESS -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.PUBLIC_ACCESS.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.PUBLIC_ACCESS.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor())
            );
            ...
            case PARANOIA -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.PARANOIA.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.PARANOIA.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_2d, "grey")
            );
            ...
            case CANDELA_OBSCURA ->
                    new SumCustomSetConfig(null, ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.CANDELA_OBSCURA.expression", userLocale)), false, true, false, null, null, AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.CANDELA_OBSCURA.name", userLocale), new DiceStyleAndColor(DiceImageStyle.polyhedral_knots, DiceImageStyle.polyhedral_knots.getDefaultColor()));
            ...
            case CANDELA_OBSCURA2 ->
                    new SumCustomSetConfig(null, ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.CANDELA_OBSCURA2.expression", userLocale)), false, true, false, null, null, AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.CANDELA_OBSCURA2.name", userLocale), new DiceStyleAndColor(DiceImageStyle.none, DiceImageStyle.none.getDefaultColor()));
            ...
            case PROWLERS_PARAGONS ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.PROWLERS_PARAGONS.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.PROWLERS_PARAGONS.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_alies_v1, DiceImageStyle.polyhedral_alies_v1.getDefaultColor()));
            ...
            case BLUEBEARD_BRIDE ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.BLUEBEARD_BRIDE.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.BLUEBEARD_BRIDE.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_alies_v2, "blue_and_gold"));
            case EXPANSE -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.EXPANSE.expression", userLocale)),
                    AnswerFormatType.only_dice,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.EXPANSE.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.expanse, "mars_light")
            );
            case ALIEN ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.ALIEN.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.ALIEN.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_knots, "blue"));
            case HEROES_OF_CERULEA -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.HEROES_OF_CERULEA.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.HEROES_OF_CERULEA.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor())
            );
            ...
            case MARVEL ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.MARVEL.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.reroll, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.MARVEL.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.d6_marvel_v2, D6MarvelV2.WHITE));
            case DND5_CALC2 ->
                    new SumCustomSetConfig(null, ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.DND5_CALC2.expression", userLocale)), true, true, false, null, null, AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.DND5_CALC2.name", userLocale), new DiceStyleAndColor(DiceImageStyle.polyhedral_alies_v2, "blue_and_silver"));
            case PBTA -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.PBTA.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.PBTA.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_RdD, DiceImageStyle.polyhedral_RdD.getDefaultColor())
            );
            ...
            case THE_ONE_RING ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.THE_ONE_RING.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.THE_ONE_RING.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_RdD, DiceImageStyle.polyhedral_RdD.getDefaultColor()));
            case EZD6 -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.EZD6.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.EZD6.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_RdD, DiceImageStyle.polyhedral_RdD.getDefaultColor())
            );
            ...
            case REBELLION_UNPLUGGED -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.REBELLION_UNPLUGGED.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.REBELLION_UNPLUGGED.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.d6_dots, D6Dotted.BLACK_AND_GOLD)
            );
            ...
            case STAR_WARS_D6 ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.STAR_WARS_D6.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.STAR_WARS_D6.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_2d, DiceImageStyle.polyhedral_2d.getDefaultColor()));
            ...
            case OATHSWORN ->
                    new SumCustomSetConfig(null, ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.OATHSWORN.expression", userLocale)), false, true, true, "val('dice',", ") if('dice'==0c>=?2,'dice'= _ ' Miss for Player', 'dice'=)", AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.OATHSWORN.name", userLocale), new DiceStyleAndColor(DiceImageStyle.polyhedral_2d, DiceImageStyle.polyhedral_2d.getDefaultColor()));
            ...
            case SALVAGE_UNION -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.SALVAGE_UNION.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.SALVAGE_UNION.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_RdD, DiceImageStyle.polyhedral_RdD.getDefaultColor())
            );
            ...
            case FALLOUT -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.FALLOUT.expression", userLocale)),
                    AnswerFormatType.full,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.FALLOUT.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_2d, PolyhedralSvgWithColor.CYAN)
            );
            ...
            case FORBIDDEN_LANDS ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.FORBIDDEN_LANDS.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.FORBIDDEN_LANDS.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_alies_v2, DiceImageStyle.polyhedral_alies_v2.getDefaultColor()));
            ...
            case WARHAMMER_AOS ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.WARHAMMER_AOS.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.reroll, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.WARHAMMER_AOS.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_alies_v2, "blue_and_gold"));
            ...
            case SHADOWDARK ->
                    new SumCustomSetConfig(null, ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.SHADOWDARK.expression", userLocale)), true, false, false, null, null, AnswerFormatType.full, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.SHADOWDARK.name", userLocale), new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_3d.getDefaultColor()));
            ...
            case OTHERSCAPE ->
                    new CustomParameterConfig(null, I18n.getMessage("rpg.system.command.preset.OTHERSCAPE.expression", userLocale), AnswerFormatType.without_expression, AnswerInteractionType.none, null, userLocale, null, I18n.getMessage("rpg.system.command.preset.OTHERSCAPE.name", userLocale), CustomParameterConfig.InputType.button, new DiceStyleAndColor(DiceImageStyle.polyhedral_RdD, DiceImageStyle.polyhedral_RdD.getDefaultColor()));
            ...
            case DAGGERHEART -> new CustomDiceConfig(null,
                    ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.DAGGERHEART.expression", userLocale)),
                    AnswerFormatType.without_expression,
                    AnswerInteractionType.none,
                    null,
                    userLocale,
                    null,
                    I18n.getMessage("rpg.system.command.preset.DAGGERHEART.name", userLocale),
                    new DiceStyleAndColor(DiceImageStyle.polyhedral_3d, DiceImageStyle.polyhedral_RdD.getDefaultColor())
            );
        };
    }
