...
public class RpgSystemCommandPreset {
    ...
    public static Config createConfig(PresetId presetId, Locale userLocale) {
        return switch (presetId) {
            ...
            case DND5 ->
                    new CustomDiceConfig(null, ButtonHelper.parseString(I18n.getMessage("rpg.system.command.preset.DND5.expression", userLocale)), DiceParserSystem.DICE_EVALUATOR, AnswerFormatType.full, null, new DiceStyleAndColor(DiceImageStyle.none, DiceImageStyle.none.getDefaultColor()), userLocale);
            case DND5_IMAGE ->
