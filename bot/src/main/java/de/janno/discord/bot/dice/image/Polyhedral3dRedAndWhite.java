...
public class Polyhedral3dRedAndWhite implements ImageProvider {
            ...
            .collect(ImmutableMap.toImmutableMap(d -> d, d -> {
                ...
                return sideStream
                        .collect(ImmutableMap.toImmutableMap(s -> s, s -> {
                            try {
                                return ImageIO.read(Resources.getResource("images/polyhedral_3d_red_and_white/d%d/d%ds%d.png".formatted(d, d, s)).openStream());
                            } catch (IOException e) {
