...
The bot supports multiple languages (currently English and German).
...
* The `d6_dot` in `black_and_white` dice images are adapted from https://speakthesky.itch.io/typeface-dicier and the Infinite Revolution RPG
