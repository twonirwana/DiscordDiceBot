...
image:https://img.shields.io/discord/898657305883725834[Discord]
...
All commands have an `answer_format` option that determines how the answer of a dice roll is shown. There are three options: `full`, `compact` and `minimal`.
