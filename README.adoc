...
The `polyhedral_black_and_gold` dice set was designed and contributed by https://www.instagram.com/alie_in_beanland/[alieinbeanland].

image:image/blackAndGoldExample.png[image,480]

==== polyhedral_3d_red_and_white
image:image/redAndWhiteExample1.png[image,,360]
image:image/redAndWhiteExample2.png[image,,360]
