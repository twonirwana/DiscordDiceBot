...
The `alies_black_gold` dice set was designed and contributed by https://www.instagram.com/alie_in_beanland/[Alie].
...
Special thank for https://www.instagram.com/alie_in_beanland/[Alie] design of the dice images.