...
public class DiscordConnectorImpl implements DiscordConnector {
    public static void createAndStart(String token, boolean disableCommandUpdate, List<SlashCommand> commands, EmbedOrMessageDefinition welcomeMessageDefinition, Set<Long> allGuildIdsInPersistence) throws Exception {
        new DiscordConnectorImpl().start(token, disableCommandUpdate, commands, welcomeMessageDefinition, allGuildIdsInPersistence);
    }

    @Override
    public void start(String token, boolean disableCommandUpdate, List<SlashCommand> commands, EmbedOrMessageDefinition welcomeMessageDefinition, Set<Long> allGuildIdsInPersistence) throws Exception {
