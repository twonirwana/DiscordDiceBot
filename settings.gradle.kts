...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("micrometer-core", "io.micrometer:micrometer-core:1.10.3")
            library("reactor-core", "io.projectreactor:reactor-core:3.5.2")
            ...
            library("assertj-core", "org.assertj:assertj-core:3.24.1")
