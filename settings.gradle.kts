...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("micrometer-core", "io.micrometer:micrometer-core:1.12.0")
            library("reactor-core", "io.projectreactor:reactor-core:3.6.0")
            ...
            library("logback-classic", "ch.qos.logback:logback-classic:1.4.13")
