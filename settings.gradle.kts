...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("micrometer-core", "io.micrometer:micrometer-core:1.13.1")
            library("reactor-core", "io.projectreactor:reactor-core:3.6.6")
            ...
            library("assertj-core", "org.assertj:assertj-core:3.26.0")
            ...
            library("avaje-config", "io.avaje:avaje-config:3.14")
