...
dependencyResolutionManagement {
    versionCatalogs {
        create("libs") {
            ...
            library("micrometer-core", "io.micrometer:micrometer-core:1.10.2")
            library("reactor-core", "io.projectreactor:reactor-core:3.5.1")
            ...
            library("assertj-core", "org.assertj:assertj-core:3.24.0")
