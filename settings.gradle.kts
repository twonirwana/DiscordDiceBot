...
dependencyResolutionManagement {
    ...
    versionCatalogs {
        create("libs") {
            ...
            library("micrometer-core", "io.micrometer:micrometer-core:1.15.1")
            library("reactor-core", "io.projectreactor:reactor-core:3.7.7")
            ...
            library("log4j-to-slf4j", "org.apache.logging.log4j:log4j-to-slf4j:2.25.0")
